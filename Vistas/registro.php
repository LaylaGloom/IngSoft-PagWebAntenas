  ...
  <div class="col-lg-8 col-md-8 col-sm-12 form-reg">
      ...
      <div class="f-cafe">
        ...
        <form method="POST" action="../controladores/registro.php">
            ...
            <input class="form-control input-sm" id="inputsm" type="email" name="correo" value="" placeholder="ejemplo@algo.com" required>
            ...
            <input class="form-control input-sm" id="inputsm" type="tel" name="numero" value="" placeholder="771-2333-425" minlength="10" maxlength="12" required>
            <br>
